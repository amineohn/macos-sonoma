...
export function LaunchPad() {
  return (
    <>
      <motion.div
        className="bg-black/50 backdrop-filter backdrop-blur-xl absolute inset-0 z-50 transition-all ease-in-out"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        ...
        <div className="container mx-auto max-w-9xl mt-20">
          <div className="grid grid-cols-7 gap-3">
            <div className="flex flex-col items-center">
              <img src="/static/images/finder-logo.png" className="w-16 h-16" />
            ...
            <div className="flex flex-col items-center">
              <img src="/static/images/music-logo.png" className="w-16 h-16" />
              <span className="text-white text-xs font-medium mt-2">Music</span>
            </div>
            <div className="flex flex-col items-center">
              <img
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-white text-xs font-medium mt-2">Mail</span>
            </div>
          </div>
        </div>
      </motion.div>
