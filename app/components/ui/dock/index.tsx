  ...
  return (
    <>
      ...
      <div
        ...
        className="z-50 animate-fade-up flex h-16 flex-row justify-center items-end border border-gray-300/20 bg-white/20 backdrop-blur-lg fixed bottom-2 left-0 right-0 px-0.5 w-max m-auto rounded-xl"
      >
